                        ...
                        <div class="card rounded-0 border-0 shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="d-flex text-body-secondary pt-3">
                                    <div class="p-2 me-2 bg-{{($dh->status == 'success')? 'success':(($dh->status == 'cancel')?'danger':'warning') }} text-white">
                                        ...
                                        <strong class="d-flex justify-content-between">
                                            ...
                                            <div>
                                                ...
                                                <span class="badge bg-success-subtle text-success"><i
                                                        class="far fa-money-bill-wave"></i> {{number_format($dh->total_money)}} VNĐ</span>
                                            </div>
                                        </strong>

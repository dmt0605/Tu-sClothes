...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/')}}css/bootstrap.min5.3.css">
    <link rel="stylesheet" href="{{asset('/')}}css/fontawesome.css">
    <link rel="stylesheet" href="{{asset('/')}}css/style.css">
</head>

<body style="background:#eff8ff" ng-app="tcApp" ng-controller="tcCtrl">
    <div class="d-flex min-vh-100">
        <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-primary" style="max-width: 280px;"
            data-bs-theme="dark">
            <a href="/"
            ...
            <ul class="nav nav-pills flex-column mb-auto" data-bs-themes>
                ...
                <li>
                    <a href="{{route('admin.user')}}" class="nav-link rounded-0 {{(Request::routeIs('admin.user'))?'active':'text-white'}}">
                    ...
                    <div class="d-flex justify-content-between w-100">
                        <form class="d-flex w-100" role="search" data-bs-theme="light">
                            <div class="input-group">
                                <button type="submit" class="btn bg-primary rounded-0 border-white">
                                    <i class="far fa-search"></i>
                                </button>
                                <input class="form-control me-2 rounded-0 border-white" type="search"
                                    placeholder="Search">
                            </div>
                        </form>
                    ...
                    <div class="collapse navbar-collapse w-100" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto" data-bs-theme="light">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <img src="/images/duongtu.jpg" alt="" width="32" height="32"
